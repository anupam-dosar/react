...
function BookingRow({
  ...
  const { updateCheckout, isCheckingout } = useCheckout();
      ...
      <Modal>
        <Menus.Menu>
          ...
          <Menus.List id={bookingId}>
            ...
            {status === "unconfirmed" && (
              <Menus.Button onClick={() => navigate(`/bookings/${bookingId}/check-in`)}>
                <HiArrowDownOnSquare />
                Check In
              </Menus.Button>
            )}
            {status === "checked-in" && (
              <Menus.Button onClick={() => updateCheckout(bookingId)} disabled={isCheckingout}>
                <HiArrowUpOnSquare />
                Check Out
              </Menus.Button>
            )}
